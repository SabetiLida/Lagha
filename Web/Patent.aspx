<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Patent" Title="Patent" CodeBehind="Patent.aspx.cs" %>

<asp:Content ContentPlaceHolderID="PageHeaderContentPlaceHolder" runat="server">
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="divOperations" runat="server">
        ...
        <div id="dvCommands" runat="server" style="width: 97%;">
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click"
                OnClientClick="return confirm('Do you want to update this patent? Are you sure?');" />
            <asp:Button ID="btnRemove" runat="server" OnClick="btnRemove_Click" Text="Remove"
                OnClientClick="return confirm('Do you want to remove this patent? Are you sure?');" />&nbsp;
        </div>
    </div>

    <div id="divDetail" runat="server" style="margin-top: 10px; width: 99%;">
        <div id="dvMain">
            <h3 style="color: White; margin-left: 5px;">Information</h3>
        </div>
        <div style="width: 97%;">
            <fieldset style="margin-left: 1%; width: 100%">
                <legend>Patent Information</legend>
                <div style="width: 97%;">
                        ...
                        <table id="tblInformation" style="width: 96%">
                            <tr>
                                ...
                                <td style="width: 228px">
                                    ...
                                    <asp:TextBox ID="txtFillingNo" runat="server" Width="100px"></asp:TextBox>
                                ...
                                <td style="width: 322px">
                                    <asp:Label ID="lblYear" runat="server" Text="Year"></asp:Label><asp:RegularExpressionValidator ID="ctrlYearValidator" runat="server" ControlToValidate="txtYear"
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <asp:TextBox ID="txtTradeMark" runat="server" Width="99%" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 1px;"></td>
                                <td style="width: 270px;">
                                    ...
                                    <asp:TextBox ID="txtRegNo" runat="server" Width="145px"></asp:TextBox>
                                    <asp:CustomValidator ID="ctrlRegNoExistanceValidator" runat="server" ControlToValidate="txtRegNo"
                                ...
                                <td style="width: 350px">
                                    ...
                                    <asp:Label
                                        ID="lblRegDateG" runat="server"></asp:Label></td>
                                <td style="width: 322px;">&nbsp;<asp:Label ID="lblRegDate" runat="server" Text="Registration Date:"></asp:Label><asp:CustomValidator
                            ...
                            <tr>
                                <td style="width: 1px;"></td>
                                <td style="width: 270px;" dir="ltr">
                                    <asp:Label ID="lblAppNo" runat="server" Text="Application Number:" Width="124px"></asp:Label><asp:RegularExpressionValidator ID="ctrlAppNoValidator" runat="server" ControlToValidate="txtAppNo"
                                        ErrorMessage="Invalid No!" ValidationExpression="\d+"></asp:RegularExpressionValidator><br />
                                    <asp:TextBox ID="txtAppNo" runat="server" Width="145px"></asp:TextBox><asp:CustomValidator ID="ctrlAppNoExistanceValidator" runat="server" ControlToValidate="txtAppNo"
                                ...
                                <td style="width: 214px;">
                                    ...
                                    <asp:TextBox ID="txtAppDateYear" runat="server" MaxLength="4" Width="30px"></asp:TextBox><asp:Label
                                        ID="Label8" runat="server">/</asp:Label><asp:TextBox ID="txtAppDateMonth" runat="server"
                                            MaxLength="2" Width="15px"></asp:TextBox><asp:Label ID="Label9" runat="server" Text="/"></asp:Label><asp:TextBox
                                                ID="txtAppDateDay" runat="server" MaxLength="2" Width="15px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 1px;"></td>
                                <td style="width: 228px;">
                                    <asp:Label ID="lblFirstAnnuityYear" runat="server" Text="Annuity Number:"></asp:Label><br />
                                    <asp:DropDownList ID="drpNextAnnuityYear" runat="server" Width="64px">
                                ...
                                <td style="width: 350px">
                                    <asp:Label ID="Label1" runat="server" Text="Next Annuity Date: (Gregorian)"></asp:Label><br />
                                    <asp:Label ID="lblNextAnnuityDateG" runat="server"></asp:Label>
                                </td>
                                <td style="width: 322px;" dir="ltr">&nbsp;<asp:Label ID="lblNextAnnuityDate" runat="server" Text="Next Annuity Date:"></asp:Label><asp:CustomValidator
                                    ID="ctrlNextAnnuityDateValidator" runat="server" ErrorMessage="Invalid Date!"
                                    OnServerValidate="ctrlNextAnnuityDateValidator_ServerValidate"></asp:CustomValidator><br />
                                    <asp:TextBox
                                        ID="txtNextAnnuYear" runat="server" MaxLength="4" Width="30px"></asp:TextBox><asp:Label
                                            ID="Label5" runat="server">/</asp:Label><asp:TextBox ID="txtNextAnnuMonth" runat="server"
                                                MaxLength="2" Width="15px"></asp:TextBox><asp:Label ID="Label10" runat="server" Text="/"></asp:Label><asp:TextBox
                                                    ID="txtNextAnnuDay" runat="server" MaxLength="2" Width="15px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 1px"></td>
                            ...
                            <tr>
                                <td style="width: 1px"></td>
                                <td style="width: 228px">&nbsp;<asp:Label ID="lblPowerAtTorney" runat="server" Text="Power Of Attorney:"></asp:Label><asp:RegularExpressionValidator ID="ctrlPoweralValidator" runat="server" ControlToValidate="txtPowerOfAttorney"
                                    ErrorMessage="Invalid No!" ValidationExpression="(\d){1,15}"></asp:RegularExpressionValidator><asp:TextBox ID="txtPowerOfAttorney" runat="server" Width="115px"></asp:TextBox></td>
                                <td style="width: 350px">
                            ...
                            <tr>
                                <td style="width: 1px"></td>
                                <td style="width: 228px"><asp:Label ID="lblAdditionalGoodsClasses" runat="server" Visible="false" Text="Additional of goods and classes (AppNo)"></asp:Label>
                                    <asp:RegularExpressionValidator ID="ctrlAdditionalGoodsClassesValidator" runat="server" ControlToValidate="txtAdditionalGoodsClasses"
                                        ErrorMessage="Invalid No!" ValidationExpression="\d+" Visible="false"></asp:RegularExpressionValidator>
    ...
    <div id="divGrid" runat="server" style="width: 97%; margin-left: 1%; margin-top: 5px">
        <asp:GridView ID="grdPatent" runat="server" AutoGenerateColumns="False" CaptionAlign="Left" Caption="Patent Applicants:"
            DataKeyNames="ID" HorizontalAlign="Center" Width="100%" OnSelectedIndexChanged="grdPatent_SelectedIndexChanged" AllowPaging="True" AllowSorting="True" OnSorting="grdPatent_Sorting" OnPageIndexChanging="grdPatent_PageIndexChanging" BorderColor="#E0E0E0" BorderStyle="Ridge" BorderWidth="2px" BackColor="#404040" CellPadding="5">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Letters">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" Target="_self" runat="server" ImageUrl='<%#HasLetter(DataBinder.Eval(Container.DataItem,"FillingNo"))%>' NavigateUrl='<%# "Letters.aspx?FillingNo="+ DataBinder.Eval(Container.DataItem,"FillingNo")+"&LetterType=2"+"&AgentId="+DataBinder.Eval(Container.DataItem,"AgentId")%>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div id="divSearchInfo" style="position: absolute; top: 155px; left: 50px; visibility: hidden; background-color: #b0c4de;">
        <table id="table13" cellspacing="0" cellpadding="0" width="45%">
            ...
            <tr>
                <td class="TextArea" style="width: 423px; height: 267px;">
                    <table border="0" cellpadding="0" cellspacing="0" id="table1" style="border-top-style: groove; border-right-style: groove; border-left-style: groove; border-bottom-style: groove">
                        <tr>
                            <td style="text-align: left;">
                                <b>Application Number:<asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                    runat="server" ControlToValidate="txtSrchAppNo" ErrorMessage="Invalid No!" Font-Bold="False"
                            ...
                            <td>
                                <strong>Registration Number:</strong><asp:RegularExpressionValidator ID="RegularExpressionValidator2"
                                    runat="server" ControlToValidate="txtSrchRegNo" ErrorMessage="Invalid No!" Font-Bold="False"
                        ...
                        <tr>
                            <td style="text-align: left;" colspan="2">
                                <b>Agent:</b><br />
                                <asp:DropDownList ID="drpSrchAgent" runat="server" Width="280px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;" colspan="2">
                                <b>Agent-2:</b><br />
                                <asp:DropDownList ID="drpSrchAgent2" runat="server" Width="280px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                ...
                                <asp:TextBox ID="txtsrchTitle" runat="server" Width="444px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
